# BE-01.1: Client Company Profile — Real Data & Settings

**ID:** BE-01.1 (subtask of [BE-01](BE-01.md))
...
- Deleting clients
- Managing `ClientSupplierLink` (covered by BE-01)
...
!!! tip "Full task details"
    ...
    `docs/_ai_context/CURRENT_TASK_Client_Profile_Real_Data.md`
